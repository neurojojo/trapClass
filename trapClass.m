classdef trapClass < handle
    ...
    methods
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%
        function obj = trapClass( tracksTable, segsTable )
        ...
        function obj = locateTraps(obj)
            ...
            tmp_tbl = tmp_tbl( or(tmp_tbl.segType==0,tmp_tbl.segType==1), : );
        ...
        function stats = computeTrappedSegStats(obj)
           
            varfun(@(x) histcounts(x,[0:4]), obj.traps_segs_join_tbl, 'InputVariable', 'segType', 'GroupingVariable', 'trapIdx' );
